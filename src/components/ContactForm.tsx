  ...
  if (isSuccess) {
    return (
      <div className="glass p-8 text-center rounded-sm">
        ...
        <h3 className="text-2xl font-heading font-bold text-slate-900 mb-2">Mensaje Enviado Exitosamente</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="glass-card p-8 rounded-sm">
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              id="name"
              required
              className="w-full bg-slate-50 border border-slate-300 rounded-sm px-4 py-3 text-slate-900 focus:outline-none focus:border-gold-500 focus:ring-1 focus:ring-gold-500 transition-all"
        ...
        <div>
          <label htmlFor="service" className="block text-sm font-medium text-slate-600 mb-2">
          ...
          <input
            ...
            readOnly
            value={serviceName}
            className="w-full bg-white border border-slate-300 rounded-sm px-4 py-3 text-slate-500 cursor-not-allowed"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={4}
            className="w-full bg-slate-50 border border-slate-300 rounded-sm px-4 py-3 text-slate-900 focus:outline-none focus:border-gold-500 focus:ring-1 focus:ring-gold-500 transition-all resize-none"
        ...
        <button
          ...
          className="w-full flex justify-center items-center gap-2 bg-gold-500 hover:bg-gold-400 text-slate-900 px-8 py-4 rounded-sm font-bold transition-all shadow-lg disabled:opacity-70 disabled:cursor-not-allowed text-lg"
        >
          {isSubmitting ? (
            "Procesando..."
          ) : (
