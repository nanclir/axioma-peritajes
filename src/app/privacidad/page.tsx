    ...
    <div className="min-h-screen bg-navy-900 pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-heading font-bold text-white mb-4">Política de Privacidad</h1>
        ...
        <div className="prose prose-invert prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-heading font-bold text-white mt-8 mb-4">3. Uso de la información</h2>
          <p className="text-slate-300 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-heading font-bold text-white mt-8 mb-4">6. Contacto</h2>
