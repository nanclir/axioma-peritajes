      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="glass-card p-8 group">
            ...
            <h3 className="text-xl font-heading font-bold text-slate-900 mb-4">Conocimiento como Activo</h3>
          ...
          <div className="glass-card p-8 group">
            ...
            <h3 className="text-xl font-heading font-bold text-slate-900 mb-4">IA Operativa</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div className="glass-card p-8 group">
            ...
            <h3 className="text-xl font-heading font-bold text-slate-900 mb-4">Rigor Metodológico</h3>
            <p className="text-slate-500 leading-relaxed">
        ...
        <div className="bg-slate-100/50 border border-slate-200 rounded-sm p-12 text-center mb-20 shadow-inner">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto text-left">
            <div className="glass-card p-6 border-l-4 border-l-gold-500">
              ...
              <p className="text-slate-500 text-sm mb-4">Ingeniero Civil, MS.c., PhD. Civil Engineering</p>
            ...
            <div className="glass-card p-6 border-l-4 border-l-gold-500">
              ...
              <p className="text-slate-500 text-sm mb-4">Ingeniero Civil, Especialista en Gerencia de Construcciones, Magíster en Filosofía</p>
              <p className="text-slate-500 text-sm">
