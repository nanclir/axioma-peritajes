    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="relative pt-20 pb-24 border-b border-slate-200">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-slate-900 mb-6">Auditoría Forense Técnica</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Content */}
          <div>
            <h2 className="text-2xl font-heading font-bold text-slate-900 mb-6">La Verdad Detrás de la Infraestructura</h2>
            ...
            <ul className="space-y-4 mb-10">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-600">Análisis retrospectivo de diseños frente al desempeño real de la estructura.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-gold-500 shrink-0" />
                <span className="text-slate-600">Trazabilidad de ensayos de laboratorio y control de calidad de materiales.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-gold-500 shrink-0" />
                <span className="text-slate-600">Investigación de sobrecostos mediante análisis de presupuestos y actas de obra.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-gold-500 shrink-0" />
                <span className="text-slate-600">Dictámenes de responsabilidad profesional en fallas constructivas.</span>
              </li>
            </ul>

            <div className="bg-white/50 p-6 border-l-4 border-gold-500 rounded-r-sm">
              <h3 className="text-lg font-heading font-bold text-slate-900 mb-2">Para Casos de Alta Complejidad</h3>
