    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="relative pt-20 pb-24 border-b border-slate-200">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-slate-900 mb-6">Peritaje Estructural</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Content */}
          <div>
            <h2 className="text-2xl font-heading font-bold text-slate-900 mb-6">Alcance del Dictamen Pericial</h2>
            ...
            <ul className="space-y-4 mb-10">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-600">Análisis patológico de estructuras en concreto y acero.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-gold-500 shrink-0" />
                <span className="text-slate-600">Evaluación de vulnerabilidad sísmica y cumplimiento normativo (NSR-10).</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-gold-500 shrink-0" />
                <span className="text-slate-600">Determinación de causas en colapsos o fallas de servicio.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-gold-500 shrink-0" />
                <span className="text-slate-600">Revisión experta de memorias de cálculo y planos estructurales.</span>
              </li>
            </ul>

            <div className="bg-white/50 p-6 border-l-4 border-gold-500 rounded-r-sm">
              <h3 className="text-lg font-heading font-bold text-slate-900 mb-2">Contradicción del Dictamen</h3>
