    ...
    <div className="min-h-screen bg-slate-50 pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-heading font-bold text-slate-900 mb-4">Términos y Condiciones</h1>
          <p className="text-slate-500">Última actualización: Mayo de 2026</p>
        </div>

        <div className="prose  prose-slate max-w-none">
          <h2 className="text-2xl font-heading font-bold text-slate-900 mt-8 mb-4">1. Aceptación de los Términos</h2>
          ...
          <h2 className="text-2xl font-heading font-bold text-slate-900 mt-8 mb-4">2. Naturaleza de los Servicios</h2>
          <p className="text-slate-500 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-heading font-bold text-slate-900 mt-8 mb-4">3. Propiedad Intelectual</h2>
          <p className="text-slate-500 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-heading font-bold text-slate-900 mt-8 mb-4">4. Exactitud de la Información</h2>
          <p className="text-slate-500 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-heading font-bold text-slate-900 mt-8 mb-4">5. Limitación de Responsabilidad</h2>
          <p className="text-slate-500 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-heading font-bold text-slate-900 mt-8 mb-4">6. Ley Aplicable</h2>
