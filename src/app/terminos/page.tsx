...
export const metadata = {
  title: "Términos y Condiciones | Axioma Peritajes",
  description: "Términos y condiciones de uso del sitio web y servicios de Axioma Peritajes.",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert prose-slate max-w-none">
          ...
          <p className="text-slate-300 leading-relaxed mb-6">
            Al acceder y utilizar el sitio web de Axioma Peritajes (en adelante, "la Firma"), usted acepta cumplir y estar sujeto a estos Términos y Condiciones de uso. Si no está de acuerdo con alguna parte de estos términos, no debe utilizar nuestro sitio web.
          </p>
          ...
          <p className="text-slate-300 leading-relaxed mb-6">
            Todo el contenido presente en este sitio, incluyendo pero no limitado a textos, gráficos, logotipos, íconos, imágenes, metodologías descritas y código fuente, es propiedad exclusiva de Axioma Peritajes o de sus licenciantes y está protegido por las leyes de propiedad intelectual de Colombia e internacionales. Queda estrictamente prohibida su reproducción sin autorización escrita.
          </p>
          ...
          <p className="text-slate-300 leading-relaxed mb-6">
            En ningún caso Axioma Peritajes será responsable por cualquier pérdida o daño, incluyendo sin limitación, pérdida o daño indirecto o consecuente, o cualquier pérdida o daño derivado de la pérdida de datos o beneficios que surjan de, o en conexión con, el uso de este sitio web.
          </p>
